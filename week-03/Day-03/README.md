...
# 22. What You Should Be Able to Do for the Exam
...
and how it processes each element in a collection.
...
You should know that tuples are:
...
You should be comfortable understanding structures such as:
...
and how functions can be combined:
...
Today you moved from working with simple variables and values to working with **collections and Python data structures**.
